...
use lambdaworks_math::{elliptic_curve::short_weierstrass::point::ShortWeierstrassProjectivePoint, traits::{AsBytes, ByteConversion}};
use sha256::digest;
...
impl Signature {
    ...
    pub fn verify(&self, message: String, public_key: ShortWeierstrassProjectivePoint<BLS12381Curve>) -> anyhow::Result<bool, anyhow::Error> {
        let generator = BLS12381Curve::generator();
